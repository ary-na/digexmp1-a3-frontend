        ...
        const template = html`
            <div class="row justify-content-center h-100">
                <div class="row g-4 col-xs-12 col-sm-10 col-md-8 col-lg-6 col-xl-5 bg-white shadow-sm rounded-1 my-auto p-5">
                    ...
                    <img class="w-100 d-block" src="/images/welcome-page.png" alt="This is an image of the coffee on café logo.">
                    <h1>Welcome ${Auth.currentUser.firstName}!</h1>
                    ${Auth.currentUser.accessLevel === 1 
                            ? html`<p>Find your <span class="fst-italic">favourite barista</span>, <span class="fst-italic">drink</span> and <span class="fst-italic">order</span> away with coffee on.</p>`
